  ...
  return (
    <main className="container py-16">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-xl text-muted-foreground">Product analytics</p>
        <p className="mt-4 text-base text-muted-foreground">Event tracking, funnels, retention, and feature adoption — without the Amplitude price tag.</p>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core capability that sets EventFlow apart.</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent>Integrate EventFlow into your stack in minutes.</CardContent>
        </Card>
      </section>
    </main>
  );
