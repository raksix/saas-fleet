...
## Domain — Department hierarchies

### `department_hierarchis`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `department_hierarchi_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Real-time actuals

### `real-time_actuals_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Overrun alerts (AI)
