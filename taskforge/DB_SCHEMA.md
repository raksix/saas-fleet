...
## Domain — AI prioritization engine

### `ai_prioritization_ens`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `ai_prioritization_en_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Slack & Linear sync

### `slack_&_linear_sync_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Blocker detection radar (AI)
