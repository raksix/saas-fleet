...
## Domain — Brand-voice training

### `brand-voice_trainings`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `variant_generation_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Auto A/B testing (AI)
