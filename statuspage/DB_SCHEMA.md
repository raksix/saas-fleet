...
## Domain — Public/private pages

### `public/private_pagess`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `incident_timelines_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Subscriber notifications (AI)
