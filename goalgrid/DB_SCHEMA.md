...
### `okr_hierarchy_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Weekly check-in flow

### `weekly_check-in_flow_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Visual progress charts (AI)
