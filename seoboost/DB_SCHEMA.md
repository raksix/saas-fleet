...
## Domain — Content brief generator

### `content_brief_generas`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `content_brief_genera_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Draft scoring

### `draft_scoring_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — SERP tracking (AI)
