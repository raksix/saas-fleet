...
## Domain — Composite health score

### `composite_health_scos`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `composite_health_sco_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Churn early-warning

### `churn_early-warning_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Playbook triggers (AI)
