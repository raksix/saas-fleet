...
## Domain — Carrier rate compare

### `carrier_rate_compares`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `carrier_rate_compare_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Bulk label print

### `bulk_label_print_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Tracking page (AI)
