...
## Domain — Pomodoro + flow tracking

### `pomodoro_+_flow_tracs`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `pomodoro_+_flow_trac_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Aggregate (non-surveillance) analytics

### `aggregate_(non-surve_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Calendar integration (AI)
