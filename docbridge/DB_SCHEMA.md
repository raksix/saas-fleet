...
## Domain — Style consistency AI

### `style_consistency_ais`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `style_consistency_ai_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Restructure suggestions

### `restructure_suggesti_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Comment summarization (AI)
