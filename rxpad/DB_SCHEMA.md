...
### `epcs_e-prescribing_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Formulary + interactions

### `formulary_+_interact_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Pharmacy network (AI)
