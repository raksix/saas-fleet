  ...
  return (
    <main className="container py-16">
      <section className="mx-auto max-w-3xl text-center">
        <h1 className="text-5xl font-bold tracking-tight">ABTestly Cloud</h1>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core capability that sets ABTestly Cloud apart.</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent>Integrate ABTestly Cloud into your stack in minutes.</CardContent>
        </Card>
      </section>
    </main>
  );
