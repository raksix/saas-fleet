...
## Domain — RFM + behavioral segments

### `rfm_+_behavioral_segs`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `rfm_+_behavioral_seg_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — AI cohort discovery

### `ai_cohort_discovery_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Segment export to ad platforms (AI)
