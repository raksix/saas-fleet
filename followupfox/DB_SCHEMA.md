...
## Domain — Multi-channel cadences

### `multi-channel_cadencs`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `multi-channel_cadenc_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Reply detection

### `reply_detection_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Reply classification (AI)
