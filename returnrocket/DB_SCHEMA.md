...
### `branded_portal_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Exchange-first flow

### `exchange-first_flow_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Reverse logistics (AI)
