...
## Domain — Plan/proration engine

### `plan/proration_engins`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `plan/proration_engin_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Coupons & trials

### `coupons_&_trials_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Churn analytics (AI)
