...
## Domain — Voice capture (mobile)

### `voice_capture_(mobils`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `entity_extraction_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Bidirectional links (AI)
