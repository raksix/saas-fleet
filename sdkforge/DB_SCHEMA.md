...
## Domain — Multi-language output

### `multi-language_outpus`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `multi-language_outpu_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Idiomatic code

### `idiomatic_code_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — CI integration (AI)
