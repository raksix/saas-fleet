...
## Domain — Rubric-based scoring

### `rubric-based_scorings`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `rubric-based_scoring_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Teacher override

### `teacher_override_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Class analytics (AI)
