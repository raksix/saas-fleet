...
## Domain — Record-once persona cuts

### `record-once_persona_s`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `record-once_persona__events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Interactive overlays

### `interactive_overlays_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Viewer analytics (AI)
