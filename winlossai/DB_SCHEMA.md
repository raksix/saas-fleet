...
## Domain — Win/loss categorizer

### `win/loss_categorizers`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `win/loss_categorizer_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Trend dashboards

### `trend_dashboards_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Buyer-sentiment scoring (AI)
