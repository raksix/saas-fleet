...
## Domain — Unified campaign canvas

### `unified_campaign_cans`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `unified_campaign_can_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Cross-channel attribution

### `cross-channel_attrib_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Asset library (AI)
