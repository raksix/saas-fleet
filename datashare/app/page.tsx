  ...
  return (
    <main className="container py-16">
      <section className="mx-auto max-w-3xl text-center">
        <h1 className="text-5xl font-bold tracking-tight">DataShare</h1>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core capability that sets DataShare apart.</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent>Integrate DataShare into your stack in minutes.</CardContent>
        </Card>
      </section>
    </main>
  );
