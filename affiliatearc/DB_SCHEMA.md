...
## Domain — Affiliate recruitment

### `affiliate_recruitmens`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `affiliate_recruitmen_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Coupon/UTM tracking

### `coupon/utm_tracking_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Auto payouts (AI)
