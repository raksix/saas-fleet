...
## Domain — Boolean + multivariate

### `boolean_+_multivarias`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `boolean_+_multivaria_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Percentage rollouts

### `percentage_rollouts_configs`
- `org_id fk orgs`
- `config jsonb`
