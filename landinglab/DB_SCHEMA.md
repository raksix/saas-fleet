...
## Domain — Visual variant editor

### `visual_variant_editos`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `visual_variant_edito_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Bayesian stats engine

### `bayesian_stats_engin_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Auto-promote winner (AI)
