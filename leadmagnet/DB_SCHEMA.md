...
## Domain — Drag-drop form builder

### `drag-drop_form_builds`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `drag-drop_form_build_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Drip campaign engine

### `drip_campaign_engine_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Lead scoring (AI)
