...
## Domain — Recurring + usage billing

### `recurring_+_usage_bis`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `recurring_+_usage_bi_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Dunning sequences

### `dunning_sequences_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Stripe/GoCardless (AI)
