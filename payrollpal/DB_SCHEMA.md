...
## Domain — Multi-country engine

### `multi-country_engines`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `multi-country_engine_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Contractor + EOR

### `contractor_+_eor_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Tax filing add-on (AI)
