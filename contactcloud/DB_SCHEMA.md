...
### `cross-source_dedup_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Auto-enrichment

### `auto-enrichment_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Identity resolution (AI)
