...
## Domain — Daily plan suggestion

### `daily_plan_suggestios`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `pattern_learning_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Energy tracking (AI)
