...
## Domain — Photo/video reviews

### `photo/video_reviewss`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `photo/video_reviews_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Post-purchase email

### `post-purchase_email_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — On-site widgets (AI)
