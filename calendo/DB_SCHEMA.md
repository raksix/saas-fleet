...
## Domain — Focus-time auto-blocking

### `focus-time_auto-blocs`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `focus-time_auto-bloc_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Deflection templates

### `deflection_templates_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Energy-aware scheduling (AI)
