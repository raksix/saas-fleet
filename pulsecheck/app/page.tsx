  ...
  return (
    <main className="container py-16">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-6 text-xl text-muted-foreground">Employee engagement surveys</p>
        <p className="mt-4 text-base text-muted-foreground">Run eNPS, pulse surveys, and exit interviews. PulseCheck surfaces themes with AI clustering.</p>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core capability that sets PulseCheck apart.</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent>Integrate PulseCheck into your stack in minutes.</CardContent>
        </Card>
      </section>
    </main>
  );
