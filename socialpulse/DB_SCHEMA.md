...
## Domain — Cross-platform metrics

### `cross-platform_metris`
- `org_id fk orgs`
- `name text`
- `status text`
- `payload jsonb`
...
### `cross-platform_metri_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Content scoring

### `content_scoring_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — Competitor benchmarking (AI)
