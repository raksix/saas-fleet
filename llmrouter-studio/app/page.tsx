  ...
  return (
    <main className="container py-16">
      <section className="mx-auto max-w-3xl text-center">
        <h1 className="text-5xl font-bold tracking-tight">LLMRouter Studio</h1>
      ...
      <section className="mt-16 grid gap-6 md:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Core capability that sets LLMRouter Studio apart.</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent>Integrate LLMRouter Studio into your stack in minutes.</CardContent>
        </Card>
      </section>
    </main>
  );
