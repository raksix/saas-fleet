...
### `360_review_engine_events`
- `parent_id fk`
- `actor_id fk users`
- `event jsonb`
- `occurred_at timestamptz`

## Domain — Calibration mode

### `calibration_mode_configs`
- `org_id fk orgs`
- `config jsonb`

## Domain — AI-suggested feedback (AI)
